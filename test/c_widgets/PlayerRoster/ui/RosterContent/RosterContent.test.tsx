 ...
 * - skeletonCount를 주면 로딩 스켈레톤 카드 수가 그 값을 따른다(ST-006, S-14)
 */
...
import { RosterContent } from '@widgets/PlayerRoster/ui/RosterContent';
...
describe('RosterContent', () => {
  ...
  it('skeletonCount를 주면 로딩 스켈레톤 카드 수가 그 값을 따른다(ST-006)', () => {
    const { container } = render(
      <RosterContent
        isLoading
        results={players}
