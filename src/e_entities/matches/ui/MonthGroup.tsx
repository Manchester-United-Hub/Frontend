import { MatchMonthGroup } from '@entities/matches/types';
import { MatchRow } from './MatchRow';

export interface MonthGroupProps {
  group: MatchMonthGroup;
}
...
export function MonthGroup({ group }: MonthGroupProps) {
  return (
    <div>
      <div className="mb-2.5 mt-6.5 flex items-center gap-2.5 text-[13px] font-bold text-muted-foreground first:mt-0">
        {group.month}
        <span
          aria-hidden="true"
