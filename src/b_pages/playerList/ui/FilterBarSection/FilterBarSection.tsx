...
/**
 * 필터바 — 포지션·활약연도·스쿼드 FilterSelect(ST-1) 3개 + RosterSearchField(ADR-1) +
 * 새로고침 버튼. 제어형(값 + 핸들러) — 값·옵션·핸들러 전부 props로 주입받아 model 훅에
 * 결합하지 않는다(usePlayerListFilters 소비는 PlayerListPage/ST-4 소관).
