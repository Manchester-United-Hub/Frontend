  ...
  return (
    ...
    >
      ...
      <div className="my-7 grid grid-cols-[1fr_auto_1fr] items-center gap-2.5">
        ...
        <span className="text-[22px] font-extrabold tracking-[0.02em] text-[#a1a1aa]">
          VS
        </span>
        <div className="flex flex-col items-center gap-2.5 text-center">
      ...
      {/* Meta: venue + datetime */}
      <div className="flex items-center justify-center gap-4.5 border-b border-t border-[#27272a] py-3.5 text-[13px] text-[#a1a1aa]">
        ...
        */}
        <span
          className={cn(
            ...
            'inline-flex items-center justify-center gap-2 rounded-md border border-transparent font-medium leading-none whitespace-nowrap transition-colors',
            DARK_OUTLINE
          )}
        >
          {match.countdown ?? '—'}
