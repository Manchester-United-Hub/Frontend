import { Hash, Target, Footprints, type LucideIcon } from 'lucide-react';
...
/**
 * 통산 스탯 카드 3개 (.rec-cards). f_shared Card 셸을 재사용하고, 아이콘·수치·
 ...
 * 우승 트로피 카드는 API에 대응 필드가 없어 제거했다(D-21).
 */
...
export function CareerStatCards({ career }: CareerStatCardsProps) {
  const stats: StatDef[] = [
