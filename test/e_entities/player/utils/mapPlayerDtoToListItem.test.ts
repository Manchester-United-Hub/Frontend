 ...
 * - photo가 PlayerListItem으로 그대로 전달된다(D-9, ST-006b)
 */
...
} from '@entities/player/utils/mapPlayerDtoToListItem';
...
describe('mapPlayerDtoToListItem', () => {
  ...
  it('photo를 PlayerListItem으로 그대로 전달한다', () => {
    const result = mapPlayerDtoToListItem(
      buildPlayerDTO({ photo: 'https://pub-8dfe7ca8163c400aac6a83640c67edb4.r2.dev/players/1485.png' }),
    );

    expect(result.photo).toBe('https://pub-8dfe7ca8163c400aac6a83640c67edb4.r2.dev/players/1485.png');
  });
