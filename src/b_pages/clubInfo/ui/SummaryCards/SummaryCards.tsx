...
import { History, MapPin, Building2, Trophy, Crown, User, LayoutGrid } from 'lucide-react';
...
// User)을 lucide 아이콘으로 치환. landing/CategoryCardsSection 선례를 따름.
...
/** 구단 요약 카드 6종 그리드. 3열 → (≤1024px) 2열 → (≤620px) 1열. 서버 컴포넌트. */
  ...
  return (
    <Shell>
      <ul
        role="list"
        aria-label="구단 요약 정보"
        className="grid grid-cols-1 gap-3.5 pb-2 pt-7 min-[620px]:grid-cols-2 lg:grid-cols-3"
      >
